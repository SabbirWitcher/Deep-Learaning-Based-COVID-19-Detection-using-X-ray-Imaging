...
# Saving the Model
model.save("model_adv2_tuberculosis_v_normal.h5")
...
plt.show()
plt.savefig('Accuracy_tuberculosis_norm.png')
...
plt.legend(['train', 'val'], loc='upper left')
plt.show()
plt.savefig('Loss_tuberculosis_norm.png')
